...
# -*- coding: utf-8 -*-
"""
Defines a class for the MC-AIXI-NADE agent.
"""
...
from pyaixi.prediction import nade
...
class MC_AIXI_NADE_Undo:
    """ A class to save details from a MC-AIXI-NADE agent to restore state later.
    """
...
class MC_AIXI_NADE_Agent(agent.Agent):
    """ This class represents a MC-AIXI-CTW agent.
        ...
        a neural autoregressive ditribution estimator (NADE).
